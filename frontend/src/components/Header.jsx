    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <div className='inline-flex items-center justify-content-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
                ...
                <form onSubmit={onSubmithandler} className='flex justify-content-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
            ...
            <img src={assets.gradientBackground} alt="gradient-bg" className='absolute -top-50 -z-1 opacity-50' />
        </div>
